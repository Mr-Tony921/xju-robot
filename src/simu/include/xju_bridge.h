...
constexpr static const char* OriPCLTopic = "/vlp_points";
constexpr static const char* DenPCLTopic = "/dense_points";
...
constexpr static const double PointCloutNoDenseGap = 0.5;
constexpr static const int PointCloutDenseRatio = 5;
...
private:
  ...
  void ori_pcl_callback(const sensor_msgs::PointCloud2::ConstPtr& msg);
